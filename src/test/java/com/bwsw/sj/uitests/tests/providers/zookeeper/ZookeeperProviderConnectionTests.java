...
public class ZookeeperProviderConnectionTests extends TestBase {

    ProviderData providerData = new ProviderData("zookeeper-auto-connection" + System.currentTimeMillis(), "Zookeeper-auto description"  + System.currentTimeMillis(), "176.120.25.19:2181", "zookeeper");
